...
<head>
  ...
  <title>Bag Ordering System : Orders</title>
  <!-- Bootstrap -->
        ...
        <div class="col-xs-12 col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2">
            ...
            <table class="table table-bordered">
                ...
                try {
                    $conn = new PDO("mysql:host=$servername;dbname=$dbname", $username, $password);
                    $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
                    $sql = "SELECT * FROM tbl_orders_a174485, tbl_staffs_a174485_pt2, tbl_customers_a174485_pt2 WHERE ";
        $sql = $sql."tbl_orders_a174485.fld_staff_num = tbl_staffs_a174485_pt2.fld_staff_num and ";
        $sql = $sql."tbl_orders_a174485.fld_customer_num = tbl_customers_a174485_pt2.fld_customer_num";
            ...
            <nav>
                <ul class="pagination">
                    ...
                    try {
                        $conn = new PDO("mysql:host=$servername;dbname=$dbname", $username, $password);
            $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
            $stmt = $conn->prepare("SELECT * FROM tbl_orders_a174485");
            $stmt->execute();
            $result = $stmt->fetchAll();
