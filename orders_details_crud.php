...
if (isset($_POST['addproduct'])) {
    try {
        $stmt = $conn->prepare("INSERT INTO tbl_orders_details_a174485(fld_order_detail_num,
...
if (isset($_GET['delete'])) {
    try {
        $stmt = $conn->prepare("DELETE FROM tbl_orders_details_a174485 where fld_order_detail_num = :did");
        $stmt->bindParam(':did', $did, PDO::PARAM_STR);
