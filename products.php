...
<div class="container-fluid dark" style="padding-bottom: 30px;">
    <div class="container">
        <div class="row">
          ...
          <div class="col-sm-9">
      <input name="pid" type="text" class="form-control" placeholder="Product ID" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_product_num']; ?>" required>
                        </div>
                    </div>
      ...
      <select name="brand" class="form-control" id="productbrand" required>
        ...
        <option value="WIWU" <?php if(isset($_GET['edit'])) if($editrow['fld_product_brand']=="WIWU") echo "selected"; ?>>WIWU</option>
        <option value="ASUS" <?php if(isset($_GET['edit'])) if($editrow['fld_product_brand']=="ASUS") echo "selected"; ?>>ASUS</option>
        <option value="DELL" <?php if(isset($_GET['edit'])) if($editrow['fld_product_brand']=="DELL") echo "selected"; ?>>DELL</option>
        <option value="Artic Hunter" <?php if(isset($_GET['edit'])) if($editrow['fld_product_brand']=="Artic Hunter") echo "selected"; ?>>Artic Hunter</option>
        <option value="American Tourister" <?php if(isset($_GET['edit'])) if($editrow['fld_product_brand']=="American Tourister") echo "selected"; ?>>American Tourister</option>
        <option value="Lenovo" <?php if(isset($_GET['edit'])) if($editrow['fld_product_brand']=="Lenovo") echo "selected"; ?>>Lenovo</option>
      </select> 
     </div>
        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input name="size" type="text" class="form-control" id="productsize"
                                   placeholder="Product Size"
                                   value="<?php if (isset($_GET['edit'])) echo $editrow['fld_product_size']; ?>" required>
                        </div>
                    </div>

                     <div class="form-group">
                        <label for="fabric" class="col-sm-3 control-label">Fabric</label>
                        <div class="col-sm-9">
                        <select name="fabric" class="form-control" id="fabric"required>
                        <option value="">Please select</option>
                         <option value="Neoprene" <?php if(isset($_GET['edit'])) if($editrow['fld_product_fabric']=="Neoprene") echo "selected"; ?>>Neoprene</option>

                        <option value="Nylon" <?php if(isset($_GET['edit'])) if($editrow['fld_product_fabric']=="Nylon") echo "selected"; ?>>Nylon</option>

                        <option value="Polyester" <?php if(isset($_GET['edit'])) if($editrow['fld_product_fabric']=="Polyester") echo "selected"; ?>>Polyester</option>

                        <option value="Cotton" <?php if(isset($_GET['edit'])) if($editrow['fld_product_fabric']=="Cotton") echo "selected"; ?>>Cotton</option>
                        </select> <br>
                        </div>
                    </div>  
                    ...
                    <div class="form-group">
                         ...
                         <div class="col-sm-9">
                         <input name="colour" type="text" class="form-control" placeholder="Product Colour" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_product_colour']; ?>"required> 
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                        <input name="ship" type="text" class="form-control"  placeholder="Ships"value="<?php if(isset($_GET['edit'])) echo $editrow['fld_product_ship']; ?>"required>  
      ...
      <table class="table table-striped table-bordered">
        ...
        <th></th>
                ...
                try {
                    ...
                    $stmt = $conn->prepare("select * from tbl_products_a174485_pt2 LIMIT {$start_from}, {$per_page}");
                    $stmt->execute();
        ...
        <?php
            try {
                $conn = new PDO("mysql:host=$servername;dbname=$dbname", $username, $password);
                        $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
                        $stmt = $conn->prepare("SELECT * FROM tbl_products_a174485_pt2");
                        $stmt->execute();
                        $result = $stmt->fetchAll();
