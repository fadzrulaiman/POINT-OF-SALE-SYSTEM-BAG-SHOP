    ...
    <div class="row">
      ...
      <div class="page-header">
        <h2>Create New Staff</h2>
            ...
            <div class="col-sm-9">
            <input name="sid" type="text" placeholder="ID" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_staff_num']; ?>"required> 
            </div>
            </div>
            <div class="form-group">
      ...
      <div class="form-group">
          ...
          <div class="col-sm-9">
      <input name="email" type="text" class="form-control" id="email" placeholder="Email Address" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_staff_email']; ?>">
      </div>
      </div>
       <div class="form-group">
        ...
        <option value="Normal Staff" <?php if(isset($_GET['edit'])) if($editrow['fld_staff_role']=="Normal Staff") echo "selected"; ?>required>Normal Staff</option>

        <option value="Admin" <?php if(isset($_GET['edit'])) if($editrow['fld_staff_role']=="Admin") echo "selected"; ?>required>Admin</option>
      </select> 
      </div>
        </div>
       <div class="form-group">
          ...
          <div class="col-sm-9">
      <input name="pass" type="text" class="form-control" id="pass" placeholder="Password" value="<?php if(isset($_GET['edit'])) echo $editrow['fld_staff_pass']; ?>"required>
      </div>
      </div>
      ...
      <tr>
        ...
        <th></th>
                ...
                try {
                    ...
                    $stmt = $conn->prepare("select * from tbl_staffs_a174485_pt2 LIMIT {$start_from}, {$per_page}");
                    $stmt->execute();
            ...
            <nav>
                <ul class="pagination">
                    ...
                    try {
                        $conn = new PDO("mysql:host=$servername;dbname=$dbname", $username, $password);
                        $conn->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
                        $stmt = $conn->prepare("SELECT * FROM tbl_staffs_a174485_pt2");
                        $stmt->execute();
                        $result = $stmt->fetchAll();
